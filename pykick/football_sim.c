/* Generated by Cython 0.15.1 on Fri Dec  5 18:19:52 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__pykick__football_sim
#define __PYX_HAVE_API__pykick__football_sim
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'pykick.football_sim' */
#define __Pyx_MODULE_NAME "pykick.football_sim"
int __pyx_module_is_main_pykick__football_sim = 0;

/* Implementation of 'pykick.football_sim' */
...
static char __pyx_k_13[] = "pykick.football_sim";
...
static char __pyx_k__football_sim[] = "football_sim";
static char __pyx_k__avg_goal_norm[] = "avg_goal_norm";
...
static PyObject *__pyx_n_s__avg_goal_norm;
static PyObject *__pyx_n_s__dt;
static PyObject *__pyx_n_s__football_sim;
...
static PyObject *__pyx_pf_6pykick_12football_sim_football_sim(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pykick_12football_sim_football_sim[] = "\n    stochstic football simulation.\n    p1: average goals per game home team\n    p2: average goals per game guest team\n    dt: time step\n    N: sample size\n    re: risk enhencement, increases the probability for a goal\n    if the score differs by one. decreases risk if score is equal.\n    ";
static PyMethodDef __pyx_mdef_6pykick_12football_sim_football_sim = {__Pyx_NAMESTR("football_sim"), (PyCFunction)__pyx_pf_6pykick_12football_sim_football_sim, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6pykick_12football_sim_football_sim)};
static PyObject *__pyx_pf_6pykick_12football_sim_football_sim(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  float __pyx_v_p1;
  float __pyx_v_p2;
  float __pyx_v_dt;
  int __pyx_v_N;
  float __pyx_v_re;
  float __pyx_v_avg_goal_norm;
  int __pyx_v_steps;
  PyArrayObject *__pyx_v_r = 0;
  PyObject *__pyx_v_results = NULL;
  PyObject *__pyx_v_goals = NULL;
  int __pyx_v_home;
  int __pyx_v_guest;
  float __pyx_v_p1_r;
  float __pyx_v_p2_r;
  ...
  int __pyx_clineno = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__p1,&__pyx_n_s__p2,&__pyx_n_s__dt,&__pyx_n_s__N,&__pyx_n_s__re,&__pyx_n_s__avg_goal_norm,0};
  __Pyx_TraceDeclarations
  __Pyx_RefNannySetupContext("football_sim");
  __Pyx_TraceCall("football_sim", __pyx_f[0], 7);
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("football_sim", 0, 2, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
        ...
        case  4:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s__re);
          if (value) { values[4] = value; kw_args--; }
        }
        case  5:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s__avg_goal_norm);
          if (value) { values[5] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "football_sim") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  6: values[5] = PyTuple_GET_ITEM(__pyx_args, 5);
    ...
    __pyx_v_p1 = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_p1 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_p2 = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_p2 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_dt = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_dt == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_dt = ((float)1.);
    }
    if (values[3]) {
      __pyx_v_N = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_N == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_N = ((int)1000000);
    }
    if (values[4]) {
      __pyx_v_re = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_re == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_re = ((float)0.15);
    }
    if (values[5]) {
      __pyx_v_avg_goal_norm = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_avg_goal_norm == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_avg_goal_norm = ((float)0.04);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("football_sim", 0, 2, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pykick.football_sim.football_sim", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;

  /* "pykick/football_sim.pyx":18
 *     '''
 * 
 ...
 */
  ...
  __pyx_v_steps = ((int)(90.0 / __pyx_v_dt));

  /* "pykick/football_sim.pyx":19
 * 
 *     cdef int steps = int(90/dt) # number of time steps
 *     p1 = (p1+avg_goal_norm)/steps # probability of home goal per time step             # <<<<<<<<<<<<<<
 *     p2 = (p2+avg_goal_norm)/steps # probability of guest goal per time step
 ...
 */
  __pyx_t_1 = (__pyx_v_p2 + __pyx_v_avg_goal_norm);
  if (unlikely(__pyx_v_steps == 0)) {
    PyErr_Format(PyExc_ZeroDivisionError, "float division");
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_v_p2 = (__pyx_t_1 / __pyx_v_steps);

  /* "pykick/football_sim.pyx":22
 *     p2 = (p2+avg_goal_norm)/steps # probability of guest goal per time step
 * 
 *     cdef np.ndarray r = np.random.ranf( N * steps )             # <<<<<<<<<<<<<<
 *     results = {}
 ...
 */
  ...
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__random); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__ranf); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyInt_FromLong((__pyx_v_N * __pyx_v_steps)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_4), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_3));
  __pyx_v_goals = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "pykick/football_sim.pyx":30
 *     cdef int i, t
 * 
 *     for i in range( N ):             # <<<<<<<<<<<<<<
 *         home = 0
 ...
 *             if abs(home-guest) == 1:
 */
      __pyx_v_p1_r = __pyx_v_p1;

      /* "pykick/football_sim.pyx":35
 *         for t in range( steps ):
 *             p1_r = p1
 *             p2_r = p2             # <<<<<<<<<<<<<<
 *             if abs(home-guest) == 1:
 *                 p1_r = p1 + re/steps
 */
      __pyx_v_p2_r = __pyx_v_p2;

      /* "pykick/football_sim.pyx":36
 *             p1_r = p1
 *             p2_r = p2
 *             if abs(home-guest) == 1:             # <<<<<<<<<<<<<<
 *                 p1_r = p1 + re/steps
 *                 p2_r = p2 + re/steps
 */
      __pyx_t_3 = PyInt_FromLong((__pyx_v_home - __pyx_v_guest)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = PyNumber_Absolute(__pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = PyObject_RichCompare(__pyx_t_4, __pyx_int_1, Py_EQ); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
 ...
 */
        ...
        __pyx_v_p1_r = (__pyx_v_p1 + (__pyx_v_re / __pyx_v_steps));

        /* "pykick/football_sim.pyx":38
 *             if abs(home-guest) == 1:
 *                 p1_r = p1 + re/steps
 *                 p2_r = p2 + re/steps             # <<<<<<<<<<<<<<
 *             elif abs(home-guest) == 0:
 ...
 */
        ...
        __pyx_v_p2_r = (__pyx_v_p2 + (__pyx_v_re / __pyx_v_steps));
        goto __pyx_L10;
      }

      /* "pykick/football_sim.pyx":39
 *                 p1_r = p1 + re/steps
 *                 p2_r = p2 + re/steps
 *             elif abs(home-guest) == 0:             # <<<<<<<<<<<<<<
 *                 p1_r = p1 - re/steps
 *                 p2_r = p2 - re/steps
 */
      __pyx_t_3 = PyInt_FromLong((__pyx_v_home - __pyx_v_guest)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = PyNumber_Absolute(__pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_9 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_9 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (__pyx_t_9) {

        /* "pykick/football_sim.pyx":40
 *                 p2_r = p2 + re/steps
 *             elif abs(home-guest) == 0:
 *                 p1_r = p1 - re/steps             # <<<<<<<<<<<<<<
 *                 p2_r = p2 - re/steps
 ...
 */
      __pyx_t_10 = ((__pyx_v_i * __pyx_v_steps) + __pyx_v_t);
      __pyx_t_3 = __Pyx_GetItemInt(((PyObject *)__pyx_v_r), __pyx_t_10, sizeof(int), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = PyFloat_FromDouble(__pyx_v_p1_r); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_2 = PyObject_RichCompare(__pyx_t_3, __pyx_t_4, Py_LT); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_9 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_9 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      if (__pyx_t_9) {

        /* "pykick/football_sim.pyx":43
 *                 p2_r = p2 - re/steps
 *             if r[i*steps+t] < p1_r:
 *                 home = home + 1             # <<<<<<<<<<<<<<
 *             elif r[i*steps+t] < p1_r+p2_r:
 *                 guest = guest + 1
 */
        __pyx_v_home = (__pyx_v_home + 1);
        goto __pyx_L11;
      }

      /* "pykick/football_sim.pyx":44
 *             if r[i*steps+t] < p1_r:
 *                 home = home + 1
 *             elif r[i*steps+t] < p1_r+p2_r:             # <<<<<<<<<<<<<<
 *                 guest = guest + 1
 ...
 */
      __pyx_t_10 = ((__pyx_v_i * __pyx_v_steps) + __pyx_v_t);
      __pyx_t_2 = __Pyx_GetItemInt(((PyObject *)__pyx_v_r), __pyx_t_10, sizeof(int), PyInt_FromLong); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = PyFloat_FromDouble((__pyx_v_p1_r + __pyx_v_p2_r)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = PyObject_RichCompare(__pyx_t_2, __pyx_t_4, Py_LT); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
        __pyx_v_guest = (__pyx_v_guest + 1);
        goto __pyx_L11;
      }
      __pyx_L11:;
    }

    /* "pykick/football_sim.pyx":46
 *             elif r[i*steps+t] < p1_r+p2_r:
 *                 guest = guest + 1
 *         res = (home, guest)             # <<<<<<<<<<<<<<
 *         if res in results.keys():
 ...
 */
    __pyx_t_3 = PyInt_FromLong(__pyx_v_home); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyInt_FromLong(__pyx_v_guest); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
    ...
    __pyx_t_2 = PyDict_Keys(__pyx_v_results); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_9 = ((PySequence_Contains(__pyx_t_2, __pyx_v_res))); if (unlikely(__pyx_t_9 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (__pyx_t_9) {

      /* "pykick/football_sim.pyx":48
 *         res = (home, guest)
 *         if res in results.keys():
 *             results[res] = results[res] + 1             # <<<<<<<<<<<<<<
 *         else:
 *             results[res] = 1
 */
      __pyx_t_2 = __Pyx_PyDict_GetItem(((PyObject *)__pyx_v_results), __pyx_v_res); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = PyNumber_Add(__pyx_t_2, __pyx_int_1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      if (PyDict_SetItem(((PyObject *)__pyx_v_results), __pyx_v_res, __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      goto __pyx_L12;
    }
    /*else*/ {

      /* "pykick/football_sim.pyx":50
 *             results[res] = results[res] + 1
 *         else:
 *             results[res] = 1             # <<<<<<<<<<<<<<
 ...
 * 
 */
      if (PyDict_SetItem(((PyObject *)__pyx_v_results), __pyx_v_res, __pyx_int_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_L12:;

    /* "pykick/football_sim.pyx":51
 *         else:
 *             results[res] = 1
 *         goals.append( home+guest )             # <<<<<<<<<<<<<<
 * 
 *     # normalize results
 */
    if (unlikely(((PyObject *)__pyx_v_goals) == Py_None)) {
    ...
    __pyx_t_4 = PyInt_FromLong((__pyx_v_home + __pyx_v_guest)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_11 = PyList_Append(__pyx_v_goals, __pyx_t_4); if (unlikely(__pyx_t_11 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }

  /* "pykick/football_sim.pyx":54
 * 
 *     # normalize results
 ...
 */
  if (unlikely(((PyObject *)__pyx_v_results) == Py_None)) {
    PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%s'", "keys"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;} 
  }
  __pyx_t_4 = PyDict_Keys(__pyx_v_results); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  if (PyList_CheckExact(__pyx_t_4) || PyTuple_CheckExact(__pyx_t_4)) {
    __pyx_t_2 = __pyx_t_4; __Pyx_INCREF(__pyx_t_2); __pyx_t_12 = 0;
    __pyx_t_13 = NULL;
  } else {
    __pyx_t_12 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
    __pyx_t_4 = __Pyx_PyDict_GetItem(((PyObject *)__pyx_v_results), __pyx_v_res); if (!__pyx_t_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_14 = __Pyx_PyObject_AsDouble(__pyx_t_4); if (unlikely(__pyx_t_14 == ((double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    if (unlikely(__pyx_v_N == 0)) {
      PyErr_Format(PyExc_ZeroDivisionError, "float division");
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_4 = PyFloat_FromDouble((__pyx_t_14 / __pyx_v_N)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    if (PyDict_SetItem(((PyObject *)__pyx_v_results), __pyx_v_res, __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pykick/football_sim.pyx":57
 *         results[res] = float(results[res]) / N
 * 
 *     return results, goals             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_INCREF(((PyObject *)__pyx_v_goals));
  PyTuple_SET_ITEM(__pyx_t_2, 1, ((PyObject *)__pyx_v_goals));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_goals));
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__avg_goal_norm, __pyx_k__avg_goal_norm, sizeof(__pyx_k__avg_goal_norm), 0, 0, 1, 1},
  {&__pyx_n_s__dt, __pyx_k__dt, sizeof(__pyx_k__dt), 0, 0, 1, 1},
  {&__pyx_n_s__football_sim, __pyx_k__football_sim, sizeof(__pyx_k__football_sim), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initfootball_sim(void); /*proto*/
PyMODINIT_FUNC initfootball_sim(void)
#else
PyMODINIT_FUNC PyInit_football_sim(void); /*proto*/
PyMODINIT_FUNC PyInit_football_sim(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_football_sim(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("football_sim"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_pykick__football_sim) {
 ...
 *     stochstic football simulation.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6pykick_12football_sim_football_sim, NULL, __pyx_n_s_13); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__football_sim, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pykick/football_sim.pyx":1
 * #! /usr/bin/python             # <<<<<<<<<<<<<<
 * # cython: profile=True
 * 
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init pykick.football_sim", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pykick.football_sim");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
